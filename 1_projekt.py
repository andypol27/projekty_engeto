...
pocet_slov_uppercase = sum(1 for word in words if word.isupper())
pocet_slov_lowercase = sum(1 for word in words if word.islower())
pocet_slov_titlecase = sum(1 for word in words if word.istitle())
pocet_slov_numeric_strings = sum(1 for word in words if word.isdigit())
print(f" There are {pocet_slov} words in the selected text.")
print(f" There are {pocet_slov_uppercase} uppercase words in the selected text.")
print(f" There are {pocet_slov_lowercase} lowercase words in the selected text.")
print(f" There are {pocet_slov_titlecase} titlecase words in the selected text.")
print(f" There are {pocet_slov_numeric_strings} numeric strings in the selected text.")
suma_cisel = 0
for word in words :
  if word.isdigit():
          suma_cisel += int(word)
